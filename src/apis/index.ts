...
const GET_TOOL_API_URL = (toolNumber: string | number) => `${TOOL_MODULE_URL}/${toolNumber}`
const PATCH_TOOL_API_URL = (toolNumber: string | number) => `${TOOL_MODULE_URL}/${toolNumber}`
const DELETE_TOOL_API_URL = (toolNumber: string | number) => `${TOOL_MODULE_URL}/${toolNumber}`
...
export const getToolRequest = async (toolNumber:string | number,accessToken:string) => {
...
export const patchToolRequest = async (requestBody:PatchToolRequestDto ,toolNumber:string | number, accessToken:string) => {
