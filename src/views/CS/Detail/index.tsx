...
export default function CSDetail() {
    ...
    const chagneDateFormat = (date: string) => {
    ...
    //function: get tool resposne 처리 함수
                ...
                <div className='main'>
                    <div className='table'>
                        ...
                        <div key={index} className='tr'>
                            <div className='td-record-date'>{chagneDateFormat(careRecord.recordDate)}</div>
                    ...
                    <div className='record-write-tool-box'>
                        <div className='input-box'>
                            ...
                            <div className='selector open'>
                                <div className='selected-item' >{selectedTool ? selectedTool.name : '사용용품'}</div>
