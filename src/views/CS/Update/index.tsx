...
// component: 고객 정보 수정 화면 컴포넌트 //
export default function CSUpdate() {
    ...
    console.log("1" + previewUrl);
    console.log("2" + profileImageFile);
    ...
    // effect: 고객 번호가 바뀔 시 요양사 리스트, 고객 정보 불러오기 함수 //
    useEffect(() => {
        if (!customerNumber) {
            navigator(CS_ABSOLUTE_PATH);
            return;
