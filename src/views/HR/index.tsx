...
export default function HR() {
    ...
    //state: 원본 리스트 상태 //
    const [originalList, setOrginalList] = useState<Nurse[]>([]);
    ...
    //function get nurse list resposne 처리 함수 //
    ...
    const onSearchButtonClickHandler = () => {
        ...
        const searchedNueseList = originalList.filter(nurse =>nurse.name.includes(searchWord));
        setTotalList(searchedNueseList)
        initViewList(searchedNueseList)
    };

    //event handler : 검색입력창 엔터 검색 처리 //
