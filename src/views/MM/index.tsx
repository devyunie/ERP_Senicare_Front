...
export default function MM() {
    ...
    const {totalList,currentPage, totalPage, totalCount, viewList,pageList,
            setTotalList,initPageList,initViewList,
            onPreSectionClickHandler,onNextSectionClickHandler,onPageClickHandlern} = usePaginaion<Tool>();
    ...
    return (
        <div id='mm-wrapper'>
            ...
            {showPatchBox && <PatchBox unShow={unshowPathcBox} />}
            <div className='top'>
            ...
            <div className='bottom'>
                <div className='pagination-box'>
                    ...
                    <div className='page-list'>
                        {pageList.map(page => <div key={page} className={page===currentPage ? 'page active':'page'} onClick={()=>onPageClickHandlern(page)}>{page}</div>)}
                    </div>
